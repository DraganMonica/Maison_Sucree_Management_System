using AutoMapper;
using Maison_Sucree.Services.ShoppingCartAPI;
using Maison_Sucree.Services.ShoppingCartAPI.Data;
using Maison_Sucree.Services.ShoppingCartAPI.Extensions;
using Maison_Sucree.Services.ShoppingCartAPI.Service;
using Maison_Sucree.Services.ShoppingCartAPI.Service.IService;
using Maison_Sucree.Services.ShoppingCartAPI.Utility;
