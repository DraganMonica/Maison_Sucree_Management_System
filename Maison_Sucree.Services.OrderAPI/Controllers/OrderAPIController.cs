using AutoMapper;
using Maison_Sucree.Services.OrderAPI.Data;
...
namespace Maison_Sucree.Services.OrderAPI.Controllers
{
    [Route("api/order")]
    [ApiController]
    public class OrderAPIController : ControllerBase
    {
        ...
        public async Task<ResponseDto> CreateOrder([FromBody] CartDto cartDto)
        {
            try
            {
                ...
                // acum creez order
                //convertesc orderheaderdto in orderheader
                OrderHeader orderCreated= _db.OrderHeaders.Add(_mapper.Map<OrderHeader>(orderHeaderDto)).Entity;
                await _db.SaveChangesAsync();

                //folosesc orderheader sa populez orderheaderid
        ...
        public async Task<ResponseDto> CreateStripeSession([FromBody] StripeRequestDto stripeRequestDto)
        {
            try
            {
                ...
                // stripe- creez a session discount option  & inauntru trebuie sa adaug couponcode -il aplic dupa foreach
                ...
                _db.SaveChanges();
                // request data va fi populat cu URL ul de l va primi din stripesession
